...
def im_detect_split(net, im, boxes, svm):
	...
	if cfg.TEST.SVM or svm:
        ...
        # were trained as linear SVMs
            score = net.blobs['cls_score'].data
        else:
...
def im_detect(net, im, boxes=None, svm=False):
    """Detect object classes in an image given object proposals.
...
def test_net(net, imdb, max_per_image=100, thresh=0.05, boxes_num_per_batch=0, vis=False, startIdx=0, endIdx=-1, saveMat=False):
